...
export default (editor: grapesjs.Editor, opts: RequiredPluginOptions) => {
  ...
  addBlock('mj-navbar', {
    ...
    content: `<mj-navbar>
    <mj-navbar-link><span>Getting started</span></mj-navbar-link>
    <mj-navbar-link><span>Try it live</span></mj-navbar-link>
    <mj-navbar-link><span>Templates</span></mj-navbar-link>
    <mj-navbar-link><span>Components</span></mj-navbar-link>
    </mj-navbar>`,
  });
  ...
  addBlock('mj-navbar-link', {
    ...
    content: `<mj-navbar-link><span>Link 1</span></mj-navbar-link>`,
  });
